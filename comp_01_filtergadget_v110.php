...
*/
if($submode=='exportDataset')ob_start();
...
if(!$datasetFile)error_alert('Filter gadget requires $datasetFile to be declared'); 
...
$filterGadgetFormMode='self-contained'; //vs enclosed
...
<div id="filterGadget">
	<div id="filterButton" onmouseover="ssS=true;" onmouseout="ssS=false;" onclick="saveSearch()" title="Modify and update filters (which records are shown)"><img id="filterGadgetIcon" src="/images/i/arrows/n2_filter.png" alt="filter" class="noghost" style="margin-top:7px;" /> <?php if($imax){ ?><a id="clearFiltersIcon" tabindex="-1" title="clear existing filters" href="#" onclick="return addFilterRow(this)"><img src="/images/i/arrows/n2_filter_clear.png" align="clear" style="margin-top:7px;" /></a><?php } ?> Filters 

	...
	<table cellpadding="0" cellspacing="0" class="tabsWrap">
		<tr>
			...
			foreach($tabLayers as $title=>$node){
				...
				?>
				<td class="<?php if($c=$tabInitialClasses[$node])echo $c;?>" style="vertical-align:bottom;"><div id="<?php echo $tabPrefix;?>_a_<?php echo $node?>" class="ab <?php echo $node==$tabDefault?'tShow':'tHide'?>"><?php echo $title?></div>

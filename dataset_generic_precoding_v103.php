...
if(!$datasetActiveControl)$datasetActiveControl='toggleActiveObject(\'$dataset\', \'$GLOBALS[$Dataset_ID]\', \'$datasetComponent\');';
...
if(!$datasetFocusViewCall){
	...
	$records=q($sql, ($datasetArrayType ? $datasetArrayType : O_ARRAY_ASSOC), ERR_ECHO);
	$recordsParams=$qr;
	$recordCols=$qr['cols'];

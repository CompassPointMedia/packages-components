...
if(!empty($removeThispageExtension)) $thispage=preg_replace('/\.(php|htm|html)$/i','',$thispage);
if(!empty($lowercaseThispage)) $thispage=strtolower($thispage);
...
if(empty($businessTitles)) $businessTitles=array('Owner','President/CEO','CIO','CFO','Marketing Director','Sales Manager','Sales Representative','Administrator','Other');

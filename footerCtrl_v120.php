...
if(empty($footerCtrlLeftBracket))       $footerCtrlLeftBracket='[';
if(empty($footerCtrlRightBracket))      $footerCtrlRightBracket=']';
...
if(empty($footerCtrlSeparator))         $footerCtrlSeparator='|';

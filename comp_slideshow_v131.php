...
if(count($ssPictures)){
	?>
	<script language="javascript" src="<?php echo $slideshowGlobalJSURL ? $slideshowGlobalJSURL : 'http://www.relatebase-rfm.com/Library/js/global_slideshow_v'.($ssSlideshowJS ? $ssSlideshowJS : '130').'.js' ;?>" type="text/javascript"></script>
